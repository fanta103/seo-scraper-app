...
7. **EVIDENCE-BASED**: Include specific facts, numbers, and claims with source attribution. Be as
comprehensive and factual as possible.

Focus on gathering the most complete picture possible with verifiable information, credible
sources, and a thorough backlink profile analysis.
`.trim();
}