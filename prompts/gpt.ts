interface ScrapingDataItem {
  ...
  You will receive scraping data containing search results, sources, and content about an entity
  (person, business, product, course, or website).
  
  ---
  
  TASK
  
  Generate a comprehensive SEO report using only the provided data. Do not fabricate, hallucinate,
  or add information not present in the sources.
