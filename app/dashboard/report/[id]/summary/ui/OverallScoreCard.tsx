...
export function OverallScoreCard({ seoReport }: OverallScoreCardProps) {
  ...
  return (
    <Card className="border-none shadow-2xl bg-gradient-to-br from-primary/5 via-primary/8 puffs to-primary/12 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-right">
            <div className="relative inline-block">
              <div
                className={`text-8xl lg:text-9xl font-bold ${getScoreGradient(
                  score
