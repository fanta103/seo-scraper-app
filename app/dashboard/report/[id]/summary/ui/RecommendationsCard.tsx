    ...
    <Card className="border bg-gradient-to-br from-card to-card/95">
      <CardHeader className="pb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-2xl">Actionable Recommendations</CardTitle>
        ...
        <div className="grid gap-6">
          {(seoReport?.recommendations || []).map((rec, index) => {
            const priorityConfig = {
              high: {
                bgClass: "bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-950/30 dark:to-pink-950/30",
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <Badge className={`${config.badgeClass} border-0 text-sm px-3 py-1 capitalize`}>
